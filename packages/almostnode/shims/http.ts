/* eslint-disable ts/no-unused-private-class-members, ts/no-this-alias, consistent-this, ts/use-unknown-in-catch-callback-variable -- vendored fork of macaly/almostnode — upstream/runtime idioms kept close to source, not restyled to this repo rules */
/**
...
import { Buffer, Readable, Writable } from "./stream";
...
export class ClientRequest extends Writable {
	...
	private readonly _bodyChunks: Uint8Array[] = [];
	private _aborted = false;
	private _timeout: number | null = null;
	private _timeoutId: ReturnType<typeof setTimeout> | null = null;
	private _requestEnded = false;
...
export function _parseWsFrame(data: Uint8Array): {
	...
	if (masked) {
		...
		return { "opcode": opcode, "payload": payload, "totalLength": offset + payloadLength };
	} else {
