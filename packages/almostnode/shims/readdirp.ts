...
import type { Stats, VirtualFS } from "../virtual-fs";
...
class ReaddirpStream {
	private readonly options: ReaddirpOptions;
	...
	private collect(dir: string, depth: number, relativePath = ""): void {
		if (!globalVFS) { return; }
		...
		try {
            ...
            // Recurse into directory
					...
					} else if (type === "files" || type === "files_directories" || type === "all") {
              // Check file filter
