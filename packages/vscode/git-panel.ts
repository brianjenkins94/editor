...
#diff-overlay-body .sxs { display: grid; align-items: stretch; padding-bottom: 8px;
  grid-template-columns: min-content minmax(0, 1fr) 14px min-content minmax(0, 1fr);
...
#diff-overlay-body .sxs-num { display: flex; justify-content: flex-end; align-items: flex-start; gap: 4px;
  padding: 0 8px 0 0; color: var(--muted); user-select: none; white-space: nowrap; }
#diff-overlay-body .sxs-lineno { padding-top: 0; }
