...
export const isSuperRef = (node: ts.Node): node is ts.PropertyAccessExpression | ts.ElementAccessExpression =>
...
export const unwrapParens = (e: ts.Expression): ts.Expression => {
...
export const nullBase = (obj: unknown, key: string, forWrite: boolean): TypeError =>
