...
import { createIndexedDBProviders, RegisteredFileSystemProvider, RegisteredMemoryFile, RegisteredReadOnlyFile, registerFileSystemOverlay } from "@codingame/monaco-vscode-files-service-override";
...
window.MonacoEnvironment = {
	...
	"getWorkerOptions": function(_, label) {
